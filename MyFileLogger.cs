...
namespace MwmBuilder
{
  internal class MyFileLogger : IMyBuildLogger
  {
    ...
    public void LogWarningInternal(string message, params object[] messageArgs) => this.LogWarning((string) null, message, messageArgs);

    public void LogMessage(string message, params object[] messageArgs) => this.WriteLog(this.InfoLog, message, messageArgs);

    public void LogWarning(string helpLink, string message, params object[] messageArgs) => this.WriteLog(this.WarningLog ?? this.InfoLog, message, messageArgs);

    public void LogError(string message, params object[] messageArgs) => this.WriteLog(this.ErrorLog ?? this.WarningLog ?? this.InfoLog, message, messageArgs);
